...
#clusters of nutritional effects
...
```{r, typical_effects_figure, fig.height = 8, fig.width = 10, fig.align = "center", eval=FALSE, message=FALSE, warning=FALSE, cache=TRUE}
#sysdimet_gamma_ar1 <- read_graph("sysdimet_gamma_ar1.graphml", "graphml")
# Typical effects of shrinkaged graph
mebn.plot_typical_effects(sysdimet_gamma_ar1_rhs_pred, 30)
```
...
mebn.plot_personal_effects(personal_graph1, 30)
```
...
mebn.plot_personal_effects(personal_graph2, 15)
```
