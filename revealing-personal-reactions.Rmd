...
## Comparing normal and gamma regressions.. absolute parameters should match?
  ...
  posterior_g <- extract(fshdl_gamma, pars = c("Y_rep", "beta", "beta_Intercept", "g_alpha", "g_beta"))
  
  mean(posterior_n$beta_Intercept)
  mean(posterior_g$beta_Intercept)
  
  mean(posterior_n$beta[2])
  gb<-mean(posterior_g$g_beta)

  ga<-mean(posterior_g$g_alpha)
  ...
  print(fshdl_gamma, pars=c("beta_Intercept", "beta"))
