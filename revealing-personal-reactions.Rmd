...
```{r, typical_effects_figure, fig.height = 6, fig.width = 6.7, echo=FALSE, fig.align = "left", message=FALSE, warning=FALSE, cache=TRUE}
source("mebn/MEBN.r")
require(igraph)
...
```{r personal_graphvisu1, eval=TRUE, fig.height = 6, fig.width = 6.7, fig.align = "left", echo=FALSE, message=FALSE, warning=FALSE}
source("mebn/MEBN.r")
require(igraph)
...
```{r personal_graphvisu22, eval=TRUE, fig.height = 6, fig.width = 6.7, fig.align = "left", echo=FALSE, message=FALSE, warning=FALSE}
source("mebn/MEBN.r")
require(igraph)
