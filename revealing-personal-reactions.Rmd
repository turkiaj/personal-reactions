...
holdout_index <- kfold_split_stratified(K = 10, x = sysdimet$SUBJECT_ID)
...
```{r gamma_ar1_ppc, echo=FALSE, message=FALSE, warning=FALSE, eval=TRUE, cache=TRUE}
mebn.target_dens_overlays("BLMM_gamma/ar1_rhs_effpred/", assumedtargets[assumedtargets$Name=="fshdl",], sysdimet)
```

```{r}

# get variation clusters of holdout persons
#sysdimet$variation_group
holdout_persons
