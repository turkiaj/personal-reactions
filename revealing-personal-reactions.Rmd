...
mebn.target_dens_overlays("BLMM_gamma/arr1/", temptarget, sysdimet)
```
...
holdout_index <- c(1,1,1,1, rep(0,length(sysdimet$SUBJECT_ID)-4))
...
sysdimet_gamma_ar1_rhs_pred <- mebn.bipartite_model(reaction_graph = initial_graph, 
                                   ...
                                   group_column = "SUBJECT_ID",
                                   local_estimation = mebn.sampling,
                                   local_model_cache = paste0("models/BLMM_gamma/ar1_rhs/1"), 
                                   stan_model_file = "mebn/BLMM_gamma_ar1_rhs_pred3.stan",
                                   reg_params = shrinkage_parameters,
                                   normalize_values = TRUE)

write.graph(sysdimet_gamma_ar1_rhs_pred, "subject_01.graphml", "graphml")
```
...
source("mebn/MEBN.r")
mebn.target_dens_overlays("BLMM_gamma/ar1_rhs/1/", t, sysdimet[holdout_index==0,])
```
...
source("mebn/MEBN.r")
target_variables<-assumedtargets[assumedtargets$Name=="fsins",]

mebn.evaluate_predictions("BLMM_gamma/ar1_rhs/1/", target_variables, sysdimet[holdout_index==1,])
```
