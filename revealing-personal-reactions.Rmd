...
```{r, typical_effects_figure, fig.height = 6, fig.width = 8, echo=FALSE, fig.align = "left", message=FALSE, warning=FALSE, cache=TRUE}
source("mebn/MEBN.r")
require(igraph)
...
```{r typical_effects_table, message=FALSE, warning=FALSE, cache=TRUE, echo=FALSE, eval=FALSE}
...
```{r typical_effects_table_latex, message=FALSE, warning=FALSE, cache=TRUE, echo=FALSE, eval=FALSE}
...
```{r high_varying_effects,  fig.height = 6, fig.width = 8}
...
```{r personal_graphvisu11, eval=TRUE, fig.height = 8, fig.width = 10, fig.align = "center", echo=FALSE, message=FALSE, warning=FALSE}
source("mebn/MEBN.r")
require(igraph)
...
```{r personal_graph3, echo=FALSE, eval=FALSE}
source("mebn/MEBN.r")
...
```{r personal_graphvisu22, eval=TRUE, fig.height = 8, fig.width = 10, fig.align = "center", echo=FALSE, message=FALSE, warning=FALSE}
source("mebn/MEBN.r")
require(igraph)
