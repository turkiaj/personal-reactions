...
sysdimet_normal <- read_graph("sysdimet_normal.graphml", "graphml")
sysdimet_gamma <- read_graph("sysdimet_gamma.graphml", "graphml")

beta_coefs <- mebn.compare_typicals(sysdimet_normal, sysdimet_gamma)

kable(beta_coefs, caption = "Comparison of beta coefficients between Normal and Gamma models") %>%
