...
```{r personal_graphvisu2, eval=FALSE, fig.height = 8, fig.width = 10, fig.align = "center", echo=FALSE, message=FALSE, warning=FALSE}
source("mebn/MEBN.r")
require(igraph)
...
```{r, echo=FALSE, eval=TRUE, cache=FALSE, fig.height=6}
source("mebn/MEBN.r")
library(bayesplot)
