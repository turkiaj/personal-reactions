...
sysdimet$effect_group <- km$cluster 
...
Cholesterol medication seems to pop out. Let's see how the clusters seem like based on nutritional effects only.

TODO: mitä tuo cholmed vaikutus edes tarkoittaa? Onko lääkettä saavilla suurempi insuliinitaso?
...
### Confidence of cholesterol medication's effect to blood insulin
