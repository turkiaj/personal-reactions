...
head(largest_personal_variance, 70)
```
...
variations_data.filtered <- variations_data[variations_data$overall_effect > 0.05,]
...
```{r effect clusters, echo=FALSE, eval=TRUE, fig.width=7, fig.height=15}
...
# Suodata näistä vain suurimmat näkyviin
variations_data.filtered <- variations_data[variations_data$overall_effect > 0.5,]
