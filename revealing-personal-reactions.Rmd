...
holdout_persons <- c(head(ligning_fsins[order(-ligning_fsins$effect),],3)$subject_id, tail(ligning_fsins[order(-ligning_fsins$effect),],3)$subject_id)
...
fsins_blmm <- mebn.get_localfit("BLMM_gamma/ar1_rhs_effpred/fshdl")
