...
The estimated value of lag 1 autocorrelation indicates how much the successive measurements are correlated. For the responses fS-HDL, fS-Kol and fP-Gluk the positive AR1-coefficient indicates that the effect of nutrition spans longer than one week 
...
```{r insuling_componentes_plot, echo=FALSE, eval=TRUE, fig.width=8, fig.height=10, cache=TRUE}
source("mebn/MEBN.r")
...
```{r variation clusters, echo=FALSE, eval=TRUE, fig.width=8, fig.height=10}
